...
import { Home, ArrowUpRight, CheckCircle2, AlertTriangle, Building as BuildingIcon, MoreVertical, CreditCard, TrendingUp, TrendingDown, DollarSign, Calendar, Zap, Palette, Utensils, Tv, Armchair, Wrench, Users, BadgePercent, ClipboardCheck, ChevronRight, Box, Clock, MapPin, ClipboardList } from 'lucide-react'
import {
    BarChart,
    Bar,
    XAxis,
...
function AdminDashboard() {
    ...
    const activeTab = searchParams.get('view') === 'accounting' ? 'accounting' : 'inventory'
    const [expandedCard, setExpandedCard] = useState<string | null>(null)

    // --- ACCOUNTING DATA MOCK ---
    const financialOverview = [
        { month: 'Ene', income: 45000, expense: 12000 },
        { month: 'Feb', income: 48000, expense: 15500 },
        { month: 'Mar', income: 52000, expense: 11000 },
        { month: 'Abr', income: 49000, expense: 18000 },
        { month: 'May', income: 55000, expense: 13500 },
        { month: 'Jun', income: 62000, expense: 14000 },
    ]
    const expenseCategories = [
        { name: 'Mantenimiento', value: 35, color: '#3b82f6' },
        { name: 'Servicios', value: 25, color: '#f97316' },
        { name: 'Impuestos', value: 20, color: '#ef4444' },
        { name: 'Personal', value: 20, color: '#10b981' },
    ]
    const propertyFinancials = [
        { name: 'Casa Tortuga', income: 120000, expense: 45000, net: 75000 },
        { name: 'Casa Bamba', income: 85000, expense: 32000, net: 53000 },
        { name: 'Villa Sol', income: 72000, expense: 28000, net: 44000 },
        { name: 'Vista Mar', income: 95000, expense: 41000, net: 54000 },
        { name: 'El Palmar', income: 45000, expense: 15000, net: 30000 },
    ]
    ...
    return (
        <div className="animate-in fade-in duration-700 space-y-6">
            ...
            {/* === VISTA INVENTARIO === */}
            {activeTab === 'inventory' && (
                <div className="grid grid-cols-1 xl:grid-cols-12 gap-2 animate-in slide-in-from-left-4 duration-500">
                    ...
                    <div className="xl:col-span-4 flex flex-col gap-2 order-last xl:order-none">
                        ...
                        <motion.div layoutId="card-categories" onClick={() => setExpandedCard('categories')} className="bg-white dark:bg-slate-900 rounded-lg p-6 shadow-sm border border-slate-200/50 dark:border-slate-800 flex-1 cursor-pointer hover:shadow-md hover:border-blue-200 dark:hover:border-blue-900 transition-all group">
                    ...
                    <div className="xl:col-span-8 flex flex-col gap-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                            ...
                            <motion.div layoutId="card-status" onClick={() => setExpandedCard('status')} className="bg-white dark:bg-slate-900 rounded-lg p-4 shadow-sm border border-slate-200/50 dark:border-slate-800 relative overflow-hidden cursor-pointer hover:shadow-md hover:border-blue-200 dark:hover:border-blue-900 transition-all group">
                            ...
                            <motion.div layoutId="card-inspections" onClick={() => setExpandedCard('inspections')} className="bg-white dark:bg-slate-900 rounded-lg p-4 shadow-sm border border-slate-200/50 dark:border-slate-800 flex flex-col justify-between cursor-pointer hover:shadow-md hover:border-blue-200 dark:hover:border-blue-900 transition-all group">
                                <div className="flex justify-between items-start mb-2">
                                    <div>
                        ...
                        <motion.div layoutId="card-buildings" onClick={() => setExpandedCard('buildings')} className="bg-white dark:bg-slate-900 rounded-lg p-4 shadow-sm border border-slate-200/50 dark:border-slate-800 cursor-pointer hover:shadow-md hover:border-blue-200 dark:hover:border-blue-900 transition-all group">
                            <div className="flex items-center justify-between mb-4">
                                <div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 order-first md:order-none">
                            {/* Card Mini 1 */}
                            <motion.div layoutId="card-damaged-mini" onClick={() => setExpandedCard('damaged-mini')} className="bg-white dark:bg-slate-900 rounded-xl p-3 md:p-5 shadow-sm border border-slate-200/50 dark:border-slate-800 flex flex-col justify-center items-center text-center hover:shadow-md transition-shadow cursor-pointer group hover:border-amber-200 dark:hover:border-amber-900">
                            ...
                            {/* Card Mini 2 */}
                            <motion.div layoutId="card-buildings-mini" onClick={() => setExpandedCard('buildings-mini')} className="bg-white dark:bg-slate-900 rounded-xl p-3 md:p-5 shadow-sm border border-slate-200/50 dark:border-slate-800 flex flex-col justify-center items-center text-center hover:shadow-md transition-shadow cursor-pointer group hover:border-purple-200 dark:hover:border-purple-900">
                            ...
                            {/* Card Mini 3 */}
                            <motion.div layoutId="card-units-mini" onClick={() => setExpandedCard('units-mini')} className="bg-white dark:bg-slate-900 rounded-xl p-3 md:p-5 shadow-sm border border-slate-200/50 dark:border-slate-800 flex flex-col justify-center items-center text-center hover:shadow-md transition-shadow cursor-pointer group hover:border-indigo-200 dark:hover:border-indigo-900">
                            ...
                            {/* Card Mini 4 */}
                            <motion.div layoutId="card-health-mini" onClick={() => setExpandedCard('health-mini')} className="bg-white dark:bg-slate-900 rounded-xl p-3 md:p-5 shadow-sm border border-slate-200/50 dark:border-slate-800 flex flex-col justify-center items-center text-center hover:shadow-md transition-shadow cursor-pointer group hover:border-emerald-200 dark:hover:border-emerald-900">
            ...
            {/* === VISTA CONTABILIDAD (NUEVA) === */}
            {
                activeTab === 'accounting' && (
                    <div className="grid grid-cols-1 xl:grid-cols-12 gap-2 animate-in slide-in-from-right-4 duration-500">

                        {/* COLUMNA IZQUIERDA (TOTALES & DONUT) */}
                        <div className="xl:col-span-4 flex flex-col gap-2 order-last xl:order-none">

                            {/* HERO FINANCIAL */}
                            <div className="relative overflow-hidden bg-gradient-to-br from-emerald-600 to-teal-800 dark:from-emerald-950 dark:to-teal-900 rounded-lg p-6 text-white shadow-lg shadow-emerald-100/50 dark:shadow-none min-h-[400px] flex flex-col justify-between group">
                                <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-400 opacity-20 rounded-full blur-3xl -mr-16 -mt-16 pointer-events-none" />
                                <div className="absolute bottom-0 left-0 w-40 h-40 bg-teal-500 opacity-10 rounded-full blur-2xl -ml-10 -mb-10 pointer-events-none" />

                                <div className="relative z-10">
                                    <p className="text-emerald-100 font-medium mb-1">Balance Total (YTD)</p>
                                    <h2 className="text-4xl font-bold tracking-tight mb-2">$854,320.00</h2>
                                ...
                                <div className="space-y-4 mt-8 relative z-10">
                                    <div className="bg-white/10 backdrop-blur-md p-4 rounded-lg border border-white/10 hover:bg-white/15 transition-colors">
                                        <div className="flex justify-between items-center mb-1">
                                            <span className="text-sm text-emerald-50">Ingresos Totales</span>
                                            <ArrowUpRight className="h-4 w-4 text-emerald-300" />
                                        </div>
                                        <p className="text-2xl font-bold">$1,240,500</p>
                                    </div>
                                    <div className="bg-white/10 backdrop-blur-md p-4 rounded-lg border border-white/10 hover:bg-white/15 transition-colors">
                                        <div className="flex justify-between items-center mb-1">
                                            <span className="text-sm text-emerald-50">Gastos Operativos</span>
                                            <TrendingDown className="h-4 w-4 text-rose-300" />
                                        </div>
                                        <p className="text-2xl font-bold">$386,180</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        {/* COLUMNA DERECHA (GRAPHS & LISTS) */}
                        <div className="xl:col-span-8 flex flex-col gap-2">
                            {/* MAIN CASHFLOW CHART */}
                            <div className="bg-white dark:bg-slate-900 rounded-lg p-6 shadow-sm border border-slate-200/50 dark:border-slate-800 h-[320px] flex flex-col justify-between">
                                <div className="flex items-center justify-between mb-2">
                                    <div>
                                        <h3 className="text-lg font-bold text-slate-900 dark:text-white">Flujo de Caja</h3>
                                        <p className="text-sm text-slate-500">Comparativa Ingresos vs Egresos (Semestre)</p>
                                    </div>
                                    <div className="flex gap-4">
                            ...
                            {/* BOTTOM ROW: Property Performance & Recent Tx */}
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 flex-1">
                                {/* Property Performance Bar Chart */}
                                <div className="bg-white dark:bg-slate-900 rounded-lg p-5 shadow-sm border border-slate-200/50 dark:border-slate-800">
                                ...
                                <div className="bg-white dark:bg-slate-900 rounded-lg p-5 shadow-sm border border-slate-200/50 dark:border-slate-800 flex flex-col">
                                    <div className="flex justify-between items-center mb-4">
                                    ...
                                    <div className="flex-1 space-y-3 overflow-auto custom-scrollbar pr-1">
                                        {[
                                            ...
                                            { desc: 'Manto. Aire Acondicionado', amount: '-$1,200', type: 'expense', date: '10 Ene' },
                                            { desc: 'Depósito Garantía - Depto 101', amount: '+$8,000', type: 'income', date: '08 Ene' },
                                        ].map((tx, i) => (
                                            <div key={i} className="flex justify-between items-center p-2 hover:bg-slate-50 dark:hover:bg-slate-800/50 rounded-lg transition-colors cursor-pointer">
                                                <div className="flex items-center gap-3">
                                                    <div className={`p-2 rounded-full ${tx.type === 'income' ? 'bg-emerald-100 text-emerald-600' : 'bg-rose-100 text-rose-600'}`}>
                                                        {tx.type === 'income' ? <DollarSign className="h-4 w-4" /> : <CreditCard className="h-4 w-4" />}
                                                    </div>
                                                    <div>
                                                        <p className="text-sm font-medium text-slate-900 dark:text-white">{tx.desc}</p>
                                                        <p className="text-xs text-slate-500">{tx.date}</p>
                                                    </div>
                                                </div>
                                                <span className={`text-sm font-bold ${tx.type === 'income' ? 'text-emerald-600' : 'text-slate-600 dark:text-slate-300'}`}>
                                                    {tx.amount}
                                                </span>
                                            </div>
                                        ))}
