                    ...
                    <div className="flex items-center justify-between w-full">
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <DropdownMenu modal={false}>
                                ...
                                <DropdownMenuContent align="end" className="!fixed !left-0 !right-0 !mx-auto !top-[60px] !w-[94vw] sm:!absolute sm:!left-auto sm:!right-auto sm:!top-auto sm:!mx-0 sm:!w-80 p-0 rounded-xl shadow-lg border border-slate-100 dark:border-slate-800 mt-2 bg-white dark:bg-slate-950">
