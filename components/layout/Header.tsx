                    ...
                    <div className="flex items-center justify-between w-full">
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <DropdownMenu modal={false}>
                                ...
                                <DropdownMenuContent align="end" className="!fixed !left-1/2 !top-[75px] !-translate-x-1/2 w-[96vw] sm:!absolute sm:!left-auto sm:!top-auto sm:!translate-x-0 sm:w-80 p-0 rounded-xl shadow-lg border border-slate-100 dark:border-slate-800 mt-2 bg-white dark:bg-slate-950">
