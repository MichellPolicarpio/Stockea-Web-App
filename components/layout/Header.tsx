                    ...
                    <div className="flex items-center justify-between w-full">
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <DropdownMenu modal={false}>
                                ...
                                <DropdownMenuContent align="end" className="w-[94vw] sm:w-80 mr-[-64px] sm:mr-0 p-0 rounded-xl shadow-lg border border-slate-100 dark:border-slate-800 mt-2 bg-white dark:bg-slate-950">
