...
export const mockApartments: Apartment[] = [
  // Building 1 - Torre Residencial Norte
  { id: 'apt-1', buildingId: 'building-1', number: '101', floor: 1, ownerId: 'owner-1', status: 'occupied', createdAt: new Date('2024-01-01'), updatedAt: new Date('2024-01-01') },
  { id: 'apt-2', buildingId: 'building-1', number: '102', floor: 1, ownerId: 'owner-1', status: 'occupied', createdAt: new Date('2024-01-01'), updatedAt: new Date('2024-01-01') },
  { id: 'apt-3', buildingId: 'building-1', number: '201', floor: 2, ownerId: 'owner-2', status: 'occupied', createdAt: new Date('2024-01-01'), updatedAt: new Date('2024-01-01') },
  { id: 'apt-4', buildingId: 'building-1', number: '202', floor: 2, status: 'vacant', createdAt: new Date('2024-01-01'), updatedAt: new Date('2024-01-01') },
